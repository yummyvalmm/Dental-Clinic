    ...
    return (
        <section id="services" className="py-20 lg:py-32 bg-bg-body overflow-hidden">
            <div className="container mx-auto px-6 lg:px-12">
                {/* Header Section */}
                <div className="flex flex-col md:flex-row justify-between items-baseline mb-12 lg:mb-24 border-b border-white/10 pb-12">
                ...
                <div className="relative">
                    {premiumServices.map((service, index) => (
                        <div
                            key={service.id}
                            className={`group relative border-b border-white/10 py-8 md:py-16 transition-all duration-500 cursor-pointer rounded-3xl px-6 -mx-6 md:hover:bg-white/5 md:hover:border-transparent md:hover:shadow-glow md:hover:z-30`}
